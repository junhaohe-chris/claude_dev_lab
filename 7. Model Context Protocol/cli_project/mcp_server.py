...
@mcp.tool(
    name="edit_document",
    description="Edit a document by replacing a string in the documents cotent with a new string",
)
def edit_document(
...
@mcp.prompt(
    name="format",
    description="Rewrite the contents fo a document in Markdown format",
)
def format_document(
